		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" method="post">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" id="form-field-1" name="member_name" placeholder="Nhập tên thành viên" class="col-xs-10 col-sm-5" />
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Email</label>
						<div class="col-sm-9">
							<input type="text" name="member_mail" placeholder="Nhập email thành viên">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="member_pass" placeholder="Nhập pass thành viên">
