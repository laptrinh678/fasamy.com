		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
				...
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1"> Danh mục thêm giao diện</label>
					<div class="col-sm-3">
						<select class="form-control" name="parent">
	                        <option value="{{$giaodien_id->catepostmodel->id}}">{{$giaodien_id->catepostmodel->cat_name}}</option>
	                       		@php
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" required="" id="form-field-1" name="name_new" placeholder="Nhập tên giao diện" class="col-xs-10 col-sm-5" value="{{$giaodien_id->ten_gd}}" />
					</div>
				</div>
				<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Ảnh giao diện 1</label>
					<div class="col-sm-9">
						<div id="div_1">
					       ...
					       <input type="file"  name="img1_new" multiple="true" onchange="previewImg(event);" id="img_file" accept="image/*" value="{{$giaodien_id->img1}}">
					...
					<div class="col-sm-9">
						<div id="div_2">	
						 <div class="div_border">
							...
							<input type="file"  name="img2_new" multiple="true" onchange="previewImg2(event);" id="img_file2" accept="image/*" value="{{$giaodien_id->img2}}">
				...
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Link liên kết</label>
					<div class="col-sm-9">
						<textarea cols="50" rows="5" name="link" >
							{{$giaodien_id->link}}
						</textarea>
					</div>
				</div>
