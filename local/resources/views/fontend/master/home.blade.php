...
<!-- CSS ================================================== -->
<div class="container-fluid nhapho wow animated zoomIn home">
    <div class="row">
     <div class="category_full">
            <div class="tab">
                <span class="dcm">
                  <a href="{{url("danh-muc/$aothudong->cat_slug.html")}}">{{$aothudong->cat_name}}</a>
                   <i class="fa fa-caret-right" aria-hidden="true"></i>
                   </span>
                <p class="arrow_cate"></p> 
            </div>
           <span class="s_right"><a href="{{url("danh-muc/$aothudong->cat_slug.html")}}"><i class="fa fa-list-alt" aria-hidden="true"></i> Xem tất cả</a></span>
        </div>
    </div>
...
<div class="container-fluid congtrinhdangthuchien wow animated zoomIn">
    <div class="row">
       <div class="category_full">
            <div class="tab">
                <span class="dcm">
                  <a href="{{url("loai-san-pham/san-pham-moi.html")}}">SẢN PHẨM MỚI</a>
                   <i class="fa fa-caret-right" aria-hidden="true"></i>
                   </span>
                <p class="arrow_cate"></p> 
            </div>
...
<div class="container-fluid kiemdinhgiamsat wow animated zoomIn">
...
<div class="container-fluid nhacaotang wow animated zoomIn">
    <div class="row">
        <div class="category_full">
            <div class="tab">
                <span class="dcm">
...
<!-- GIẢI PHÁP XÂY NHÀ-->
<div class="container-fluid giaiphapxaynha wow animated zoomIn">
    <div class="row">
