...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12 titleLogin">
			<h3>Trang chủ <i class="fa fa-angle-double-right" aria-hidden="true"></i> <span>Đăng ký thành viên</span></h3>
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="password" class="form-control" name="passConfirm" >
             <span style="color:red">{{$errors->first('passConfirm')}}</span>
          </div>
           <div class="form-group">
            <label for="pwd">Email xác nhận</label>
