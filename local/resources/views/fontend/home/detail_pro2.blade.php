	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 ">
				...
				<h1 class="titel_detail_pro"><span>Trang chủ</span> <i class="fa fa-angle-double-right" aria-hidden="true"></i> <span>Sản phẩm</span> <i class="fa fa-angle-double-right" aria-hidden="true"></i> <span>Sản phẩm mới</span></h1>
			...
			<div class="col-md-4 thongtinchitietsp">
				<div class="motram ">
